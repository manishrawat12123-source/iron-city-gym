...
const Auth = ({ onLogin }) => {
  ...
  const handleSendOTP = async (e) => {
    ...
    try {
      const response = await fetch('https://4925596f-706b-4b13-9d68-c7ac6dc719db-00-1nafdix9s7aha.pike.replit.dev/api/send-otp', {
        method: 'POST',
  ...
  const handleRegister = async (e) => {
    ...
    try {
      const response = await fetch('https://4925596f-706b-4b13-9d68-c7ac6dc719db-00-1nafdix9s7aha.pike.replit.dev/api/register', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const handleLogin = async (e) => {
    ...
    try {
      const response = await fetch('https://4925596f-706b-4b13-9d68-c7ac6dc719db-00-1nafdix9s7aha.pike.replit.dev/api/login', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const handleForgotSubmit = async (e) => {
    ...
    try {
      const res = await fetch('https://4925596f-706b-4b13-9d68-c7ac6dc719db-00-1nafdix9s7aha.pike.replit.dev/api/auth/forgot-password', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
        body: JSON.stringify({ email })
      });
  ...
  const handleVerifyResetOtp = async (e) => {
    ...
    try {
      const res = await fetch('https://4925596f-706b-4b13-9d68-c7ac6dc719db-00-1nafdix9s7aha.pike.replit.dev/api/auth/verify-reset-otp', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
  ...
  const handleResetPassword = async (e) => {
    ...
    try {
      const res = await fetch('https://4925596f-706b-4b13-9d68-c7ac6dc719db-00-1nafdix9s7aha.pike.replit.dev/api/auth/reset-password', {
        method: 'POST',
        headers: { 'Content-Type': 'application/json' },
